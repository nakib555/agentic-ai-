...
import { type MessageFormHandle, type ProcessedFile } from '../components/Chat/MessageForm/types';
import { useFileHandling } from '../components/Chat/MessageForm/useFileHandling';
import { useInputEnhancements } from '../components/Chat/MessageForm/useInputEnhancements';
...
export const useMessageForm = (
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLTextAreaElement>) => {
    if (e.key === 'Enter' && !e.shiftKey) {
        e.preventDefault();
        handleSubmit(); // Call without checking canSubmit first, let handleSubmit handle logging
    }
