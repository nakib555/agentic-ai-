...
export const BranchSwitcher: React.FC<BranchSwitcherProps> = ({ count, activeIndex, onChange, className = '' }) => {
  ...
  return (
    <div 
        className={`flex items-center gap-0.5 p-1 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md border border-zinc-200/80 dark:border-zinc-700/50 rounded-full shadow-sm shadow-zinc-200/20 dark:shadow-black/20 select-none ${className}`}
