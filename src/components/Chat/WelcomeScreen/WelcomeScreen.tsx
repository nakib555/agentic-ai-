...
export const WelcomeScreen = React.memo(({ sendMessage }: WelcomeScreenProps) => {
    const handlePromptClick = useCallback((prompt: string, options?: { isThinkingModeEnabled?: boolean }) => {
        sendMessage(prompt, undefined, options);
    }, [sendMessage]);
